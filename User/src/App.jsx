  ...
  return (
    ...
    {/* <Index/> */}
     <Routes>
        ...
        <Route path="/adminhome" element={<PrivateRoute allowedRoles={["Admin"]}> <AdminIndex /> </PrivateRoute>} />
        <Route path="/staffindex" element={<PrivateRoute allowedRoles={["Staff" ,"Manager"]}> <StaffIndex /> </PrivateRoute>} />
        <Route path="/reservationpage" element={ <PrivateRoute> <Reservation /> </PrivateRoute>} />
        <Route path="/reservationpage/:id" element={ <PrivateRoute> <Reservation /> </PrivateRoute>} />
